...
class Order(models.Model):
    ...
    payment_on_get = models.BooleanField(default=False, verbose_name="Оплата наличными")
...
class OrderItem(models.Model):
    order = models.ForeignKey(to=Order, on_delete=models.CASCADE, verbose_name="Заказ", blank=True, null=True)
